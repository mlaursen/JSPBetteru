...
public class MealPartView extends DatabaseView implements GetAllable {
	...
	public List<MealPartView> getAll(Integer mealid) { return getAll(mealid.toString()); }
	
	public List<MealPartView> getAll(String mealid) {
		return manager.executeCursorProcedure("get", mealid).toListOf(MealPartView.class);
	}
	/* (non-Javadoc)
