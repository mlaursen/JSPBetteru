...
public class DateUtil {
	...
	/**
	 * Converts a string date into a java.sql.Date using the basic format of 
	 ...
	 * @param dateString	The possible date
	 * @param dateFormat	The format to parse the date string
	...
	/**
	 * Checks if two dates are the same date by checking if they are in the same year 
	 * and they are the same day of the year.
	 * @param d1
	 * @param d2
	 * @return
	 */
