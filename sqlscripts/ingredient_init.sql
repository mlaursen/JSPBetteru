...
CREATE OR REPLACE PACKAGE BODY INGREDIENT_PKG AS
  ...
  IS
    ICATEGORY CATEGORY.NAME%TYPE;
  BEGIN
    ICATEGORY := UPPER(PCATG);
    ...
    VALUES(PID, PNAME, PBRAND, ICATEGORY, PSERV_UNIT, PSERV_SIZE, PALT_SERV_UNIT, PALT_SERV_SIZE, PCAL, PFAT, PCARB, PPROT);
    COMMIT;
