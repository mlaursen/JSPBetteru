...
CREATE OR REPLACE PACKAGE BODY ACCOUNT_PKG AS
  ...
  BEGIN
    ...
    ACCOUNT_SETTING_PKG.NEW(PID,NULL,NULL,NULL,NULL);
    EXCEPTION
    WHEN OTHERS THEN
      ROLLBACK;
      RAISE;
  ...
  BEGIN
    ...
    ACCOUNT_SETTING_PKG.NEW(IID, NULL, NULL, NULL,NULL);
    COMMIT;
...
CREATE OR REPLACE PACKAGE BODY ACCOUNT_SETTING_PKG AS
  ...
  BEGIN
    ...
    ELSE
      INSERT INTO ACCOUNT_SETTING(ID, ACCOUNTID, WEEKDAY, MULTIPLIER, HEIGHT, FORMULA, DATE_CHANGED)
      VALUES(SEQ_ACCOUNT_SETTING_ID.NEXTVAL, PACCTID, IWEEKDAY, IMULTIPLIER, PHEIGHT, IFORMULA, SYSDATE);
    END IF;
    COMMIT;
