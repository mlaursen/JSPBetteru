...
<div class="box" id="meal_${meal.id}">
  <div class="contents">
    ...
    <div class="block nutritional-facts">
      ...
      <div>
        <strong>Calories: </strong>${meal.total_calories}</div>
      <div>
        <strong>Fat: </strong>${meal.total_fat}g</div>
      <div>
        <strong>Carbohydrates: </strong>${meal.total_carbohydrates}g</div>
      <div>
        <strong>Protein: </strong>${ meal.total_protein}g</div>
    </div>
    <hr />
