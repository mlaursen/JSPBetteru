...
SET DEFINE OFF;
Insert into ACCOUNT_SETTING (ID,ACCOUNTID,WEEKDAY,MULTIPLIER,HEIGHT,DATE_CHANGED,FORMULA) values (0,0,'TUESDAY','SEDENTARY',71,to_date('21-FEB-14','DD-MON-RR'),null);
